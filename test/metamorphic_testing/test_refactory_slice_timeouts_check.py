...
class TestRefactorySliceLen(unittest.TestCase):
    ...
    def test_refactory_slice_timeout_rel(self, test_name, io_py_code, expected, variable, line):
        try:
            ...
            self.skipTest('skipped due to relevant wrong result or slicing timeout')
        except SlicingException:
            self.skipTest('skipped due to slicing exception')
