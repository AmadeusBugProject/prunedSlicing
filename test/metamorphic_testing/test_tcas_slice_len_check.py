...
from slicing.slice import get_dynamic_slice, get_relevant_slice, get_pruned_slice, get_pruned_relevant_slice
...
class TestTcasDynamicSlices(unittest.TestCase):
    ...
    def test_slice_tcas(self, test_number, test_data, expected):
        ...
        self.assert_slice_result(tcas_test_code_test, computed_slice, rel_bool_ops, exec_trace, func_param_removal, expected)
    ...
    def assert_slice_result(self, io_py_code, computed_slice, rel_bool_ops, exec_trace, func_param_removal, expected):
