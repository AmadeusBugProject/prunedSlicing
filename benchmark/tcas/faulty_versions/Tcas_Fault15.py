OLEV = 600
MAXALTDIFF = 600
MINSEP = 300+350  # Fault15: constant mutation, missing code
NOZCROSS = 100
NO_INTENT = 0
DO_NOT_CLIMB = 1
DO_NOT_DESCEND = 2
...
class Tcas:
    ...
    def alt_sep_test(self):
        enabled = self.High_Confidence and (self.Own_Tracked_Alt_Rate <= OLEV)  # Fault15: constant mutation, missing code
